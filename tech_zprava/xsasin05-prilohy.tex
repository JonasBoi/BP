...
\dirtree{%
    ...
    .2 \textbf{data/}\DTcomment{data potřebná pro experimenty}. 
        .3 modely, zpracovaná data, \dots. 
    .2 \textbf{notebooks/}. 
        .3 question\_answering.ipynb\DTcomment{experimenty se systémem a zpracování dat}. 
        .3 mbert\_czech\_squad\_fine-tuning.ipynb\DTcomment{trénink mBERT modelů}. 
        .3 albert\_squad\_fine-tuning.ipynb\DTcomment{trénink ALBERT modelů}. 
        .3 czech\_squad.py. 
        .3 czech\_squad2.py\DTcomment{skripty pro knihovnu \texttt{datasets}}. 
    ...
    .2 \textbf{web\_server/}\DTcomment{server pro demonstrační aplikaci}. 
        ...
        .3 data/\DTcomment{potřebná data pro spuštění serveru}. 
        .3 app/. 
