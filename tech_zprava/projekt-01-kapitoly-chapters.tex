...
\begin{itemize}
    ...
    neboli Natural Language Toolkit je (open-source) knihovna nabízející spoustu nástrojů pro zpracování textu a přirozeného jazyka.\par Prostřednictvím jednoduchého API umožňuje tokenizaci (včetně dělení na věty), stematizaci, tagování částí textu a jiné. 
    ...
    nabízí přístup k virtuálnímu stroji, který zprostředkovává přístup k Jupyter Notebooku v cloudu.\par 
