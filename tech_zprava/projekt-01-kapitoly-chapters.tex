...
%%TODO zdramatizovat, reálně co v práci fakt je
%%TODO přepracovat abstrakt
...
%%TODO provést všechny experimenty
...
%%TODO zhodnotit použitelnost porovnaných výsůedků v albert eval a mber eval

%=========================================================================
\section{Porovnání výsledků se současným stavem poznání}
Porovnat  s AQA atp. \cite{aqa}
%%TODO porovnat s tím, co máme k dispozici
...
%%TODO ručně vyhodnotit některé chyby a jak je případně eliminovat
...
%%TODO napsat m. fajčíkovi : syntetická tvorba q-a pairs? použití modelu na http://pcknot2.fit.vutbr.cz:8501/?
